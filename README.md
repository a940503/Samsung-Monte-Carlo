...
## Latest Example Result

Using the included command with Samsung Electronics data through `2026-06-05`, 100,000 simulated paths, and Monte Carlo parameters estimated from `2018-05-04` onward:

```text
Probability of falling below KRW 150,000 at least once within one year: 0.149%
Breached paths: 149 / 100,000
Latest price: KRW 329,000
Annualized drift: 20.27%
Annualized volatility: 29.38%
```

![Rolling volatility comparison](outputs/rolling_volatility_comparison.svg)

![Sample Monte Carlo paths](outputs/sample_monte_carlo_paths.svg)
